...
# P = np.array([0.1680912, 0.15835331, 0.21384187, 0.14223565, 0.14295074,
#               0.17452722])
# l = -1082.726962
#
# print(common.bic(X, common.GaussianMixture(Mu, var, P), l))
#
# =============================================================================
...
common.plot(X, mixture, post, 'mstep')
...
K = 6
mixture, post = common.init(X, K)
post = np.array([[0.15765074, 0.20544344, 0.17314824, 0.15652173, 0.12169798,
                  0.18553787],
