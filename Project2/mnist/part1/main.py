...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    test_error_mod3 = compute_test_error_mod3(
        test_x, test_y, theta, temp_parameter)
    print('mod_3', test_error_mod3)
    return test_error
...
error_18d = compute_test_error(test_pca, test_y, theta, temp_parameter)
print('error on 18d', error_18d)
...
error_10d_cubic = compute_test_error(test_cube, test_y, theta, temp_parameter)
print('error on 10d', error_10d_cubic)
plot_cost_function_over_time(cost_function_history)
